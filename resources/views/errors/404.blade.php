...
<head>
	...
	<meta name="keywords" content="404 Error Widget Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link href="{{ asset('errors/assets/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
	<link href='https://fonts.googleapis.com/css?family=Raleway:400,100,100italic,200,200italic,300,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900italic,900' rel='stylesheet' type='text/css'>
</head>
<body>
	<div class="main">
		...
		<div class="w3l_main_grid">
			<img src="{{ asset('errors/assets/images/1.png') }}" alt=" " class="img-responsive" />
		</div>
		...
		<div class="agile_copy_right">
			<p>&copy; 2022 404 Error Page. Design by Cyber Team</p>
		</div>
	</div>
</body>
</html>