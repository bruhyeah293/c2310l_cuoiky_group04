...
<link rel="stylesheet" type="text/css" href="{{ asset('user/assets/styles/main_styles.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('user/assets/styles/responsive.css') }}">
